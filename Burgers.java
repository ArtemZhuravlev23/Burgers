...
public class Burgers {
    ...
    public Burgers(String bun, String meat, String additionalMeat, String cheese, String greens, String mayonnaise) {
...
class BurgerMain {
    public static void main(String[] args) {
        new Burgers("bun", "pork", "cheddar", "iceberg", "mayonnaise");
        new Burgers("bun", "chicken", "smetankoviy", "rucolla");
        new Burgers("bun", "pork", "beef", "cheddar", "iceberg", "mayonnaise");
